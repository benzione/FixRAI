function [Gend,seps] = remove_ex_effect(Gstart,ex_nodes,s_nodes,class_node,seps_start,n,cond_indep,data,varargin)
...
[Gend,seps] = test_edges_S(P,C,Gend,ex_nodes,s_nodes,class_node,seps,n,cond_indep,data,varargin{:});
